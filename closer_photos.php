...
$string = file_get_contents("img/gallery/closer.json");
if ($string === false) {
    // deal with error...
}
    ...
    <?php $component->getHeader(basename($_SERVER['PHP_SELF'])); ?>
            ...
            <section class="post-wrapper-top">
                ...
                <div class="general-title text-center">
                          ...
                          <h3>GETTING CLOSER - 28.02.2020</h3>                         
                </div>                             
                    <div class="container clearfix">
                        <center>
                          <p>
                            Our second event followed the success of the first one! We talked, learned and enjoyed all types of scientific.. connections!<br/>
                            We would like to thank the library at TU Delft for hosting us and of course all our participants for joining!<br/>
