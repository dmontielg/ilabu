...
class Component_{
        ...
        function getHead(){
                ...
                <head>
                  ...
                  <link href="../lib/jetmenu_session/jetmenu.css" rel="stylesheet">
        ...
        function getHeader($pageName){
              ...
              $menu = '            
                    ...
                    else{ $menu .= '<li><a href="../team-members.php">Team Members</a></li>'; }
                    ...
                    { 
                      ...
                      $role_array = $user_event->getRolByIdUser($_SESSION["email"]);                                                                  
                      foreach($role_array as $key): $role = $key["role"]; endforeach;
                      if($role == 'public')
                      {                         
                        if(strpos($pageName, 'user_1') !== false)
                        {                                                     
                          $menu .= '<li class="active"><a href="../1/index.php">Session</a></li>';                         
                        }

                        else
                        {                           
                          $menu .= '<li><a href="../1/index.php">Session</a></li>';                         
                        }                        
                      }
                      else
                      { 
                          ##if scientist
                          if(strpos($pageName, 'user_2') !== false)
                          {                                                     
                              $menu .= '<li class="active"><a href="../2/index.php">Session</a></li>';                         
                          }
                          else
                          {                           
                                $menu .= '<li><a href="../2/index.php">Session</a></li>';                         
                          }                                                  
                      }                  
        ...
        function getSessionFormLink()
        {
          $menu = '<ul id="jetmenu_session" class="jetmenu_session blue">';          
          ...
          { 
            ...
            if($role == 'public')
            {                                     
                $menu .= '<li><a href="index.php?survey=Speed date">Speed date</a></li>';                                     
                $menu .= '<li><a href="index.php?survey=Post-session">Post-session</a></li>';                                     
                #$menu .= '<li><a href="#">Finish Event</a></li>';                                     
                #$menu .= '<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Finish event</button>';
                $menu .= '<li><a href="#" data-toggle="modal" data-target="#myModal">Finish event</a></li>';

            }
            else
            {                             
                $menu .= '<li><a href="index.php?survey=Speed date">Speed date</a></li>';                                     
                $menu .= '<li><a href="index.php?survey=Post-session 1">Post-session 1</a></li>';                                     
                $menu .= '<li><a href="index.php?survey=Post-round table">Post-round table</a></li>';                                     
                $menu .= '<li><a href="index.php?survey=Post-session 2">Post-session 2</a></li>';     
                #$menu .= '<li><a href="#">Finish Event</a></li>';                   
                #$menu .= '<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Finish event</button>';
                $menu .= '<li><a href="#" data-toggle="modal" data-target="#myModal">Finish event</a></li>';
